...
[![Tests](https://img.shields.io/badge/Tests-55%20Passed-10B981?style=for-the-badge&logo=pest&logoColor=white)](https://pestphp.com)

A high-performance document verification, eligibility tracking, and academic administration web application built for the **Institute of Distance and Open Learning (IDOL)**. 

This repository provides a complete, modern rewrite of the legacy system into **Laravel 12 + Inertia.js v2 + React 19 + TypeScript**, achieving **100% visual and functional parity** with the CodeIgniter 4 enterprise portal while maintaining high code quality and test coverage.
...
- **Backup Management**: Automated database backup triggers, download, and restore logs.
- **Mail & SMTP Config**: Manage outgoing mail server credentials and test dispatches.
...
**Test Status**: ✅ **55 tests passed (197 assertions)** with 0 failures.
...
- **Sanitized Repository**: `.env` credentials, build output, temporary caches, and system files are excluded via comprehensive `.gitignore`.
